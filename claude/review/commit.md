...
---
# TASK
Review the code changes introduced by commit '$ARGUMENTS'.
Run `git show $ARGUMENTS` to get the commit diff. Review the changes and provide prioritized findings.
